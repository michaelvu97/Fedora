...
public class Stormer extends Enemy {
    ...
    public static int DEFAULT_HITBOX_HEIGHT = 5;
     ...
     public Stormer (State state, int x, int y, double xVelocity, double yVelocity, Projectile projectileType, PowerUpPickup heldPowerUp, long timeLine, boolean canShoot) {
